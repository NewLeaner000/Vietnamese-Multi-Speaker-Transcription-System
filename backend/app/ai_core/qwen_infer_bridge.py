...
from app.ai_core.pipeline_config import QWEN_SCRIPT_PATH
...
def build_qwen_command(
    ...
    command += ["--model_path", QWEN_GGUF_MODEL_DEFAULT]
...
def run_qwen_pipeline(
    ...
    yield f"[QWEN-BRIDGE] mode={qwen_mode} | engine=llama.cpp (GGUF)"
