...
class _LocalHFLLM:
    """
    Wrapper gọi Qwen2.5-1.5B-Instruct (hoặc bất kỳ HF model nào) qua
    transformers pipeline. Tương thích với interface .invoke(messages).
    """
    ...
    def __init__(self, model_name: str = DEFAULT_LOCAL_MODEL):
        try:
            ...
            raise ImportError("Cần cài: pip install transformers torch")
    ...
    def invoke(self, messages: list) -> object:
        ...
        # Build prompt theo Qwen chat template
        chat = []
        for msg in messages:
        ...
        # Cắt phần prompt, chỉ lấy phần model sinh ra
